...
## 🛠️ Tools & Tech Stack
* **Excel / Python:** For generating and structuring the mock clinical trial audit dataset (`[clinical_trials_deviation_data.xlsx](https://github.com/user-attachments/files/28646953/clinical_trials_deviation_data.xlsx)`).
